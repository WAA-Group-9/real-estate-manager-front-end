...
function Amenities({title,description}) {
    return (
        <div className="flex-auto text-left  mt-7">
            ...
            <div className="flex  flex-wrap w-full">
                <div className="flex-auto text-left w-1/2 ">
                    <div className="flex items-center mt-9 ml-4">
                        <HomeIcon />
                        <div className="ml-7">
                            <h2 className="text-xl font-bold">Garden view{title}</h2>
                        </div>
                    </div>
                </div>
                <div className="flex-auto text-left w-1/2 ">
            ...
            <button className="mt-7 bg-white border border-black px-4 py-2 rounded flex items-center hover:bg-green-50 active:p-2">
