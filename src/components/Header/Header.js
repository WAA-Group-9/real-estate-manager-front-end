...
const Header = ({filter}) => {
    ...
    return (
        <header className="w-full h-[222px] bg-white border border-gray-300 shadow-sm relative">
            {logged?(<TopHeader styles="w-full h-[121px]  flex items-center justify-between px-6 z-20"/>):(<PublicHeader styles="w-full h-[121px]  flex items-center justify-between px-6"/>)}
